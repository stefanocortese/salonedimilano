		...
		if (body.is('.page-template-heritage') || body.is('.page-template-front-page') || body.is('.home')){
			...
			$('#wV').on('click', function(e){
				...
				.append($('<div />')
					...
					.html('<div class="video"><iframe id="ytplayer" type="text/html"  width="560" height="315" src="https://www.youtube.com/embed/_MDCFWyiMeI?autoplay=1&disablekb=1&enablejsapi=1&fs=1&showinfo=0&color=white&rel=0" frameborder="0" allowfullscreen></iframe></div><span class="close"></span>')
				)
			    ...
			    complete: function(){
			    	...
			    	$("body").delegate('.dettaglio .pulsante',"click", function(){
						...
						*/
						...
						//APPENDO I CONTENUTI DETTAGLIO ALLA PAGINA SE MOBILE PRIMA DELLA MAPPA
