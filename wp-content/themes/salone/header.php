...
<!-- <div id="page" class="hfeed site">-->
			...
			<header class="line-header">
				...
				<h2 class="line-title animated fadeIn">
					...
					//STAMPO LA DESCRIZIONE DELLA GAMMA (CATEGORIA)
						...
						if($post_type->label == 'coloring' || $post_type->label == 'caring'){
	...
	<div id="main" class=" 
<?php echo (is_page_template()=='Store-locator Page1'); ?>

<?php 
	if (is_page_template('page-templates/store-locator.php')) {echo ""; }
	else if ( is_front_page()  || is_page_template('page-templates/caring.php')) {echo "home wrapper";}
	 ?>">
