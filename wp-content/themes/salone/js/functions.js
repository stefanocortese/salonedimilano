	...
	_window.load( function() {
		...
		if (  body.is('.home')){
			...
			$('.wV').on('click', function(e){
				...
				var idYT = $(this).attr('data-video-id');
				console.log( $(this), idYT)
				e.preventDefault();
				...
				.append($('<div />')
					...
					.html('<div class="video"><iframe id="ytplayer" type="text/html"  width="560" height="315" src="https://www.youtube.com/embed/'+idYT+'?autoplay=1&disablekb=1&enablejsapi=1&fs=1&showinfo=0&color=white&rel=0" frameborder="0" allowfullscreen></iframe></div><span class="close"></span>')
				)
