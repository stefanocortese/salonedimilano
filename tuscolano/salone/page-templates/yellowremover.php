<?php
/**
 * Template Name: Yellow remover Page
 *
 * @package WordPress
...
<div id="main-content" class="main-content">
	...
	<div id="primary" class="content-area swiper-container">
		...
		?>
			...
			<article id="post-<?php the_title(); ?>" <?php post_class('swiper-slide'); ?>>
			...
			<a class="pulsante animated"  href="<?php echo $link_caring; ?>">Caring</a>

			<a class="pulsante animated"  href="<?php echo $link_coloring; ?>">Coloring</a>

			<a class="pulsante animated"  href="<?php echo $link_straightening; ?>">Straightening</a>
