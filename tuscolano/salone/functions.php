...
//RIMUOVO LE VOCI MENU PER ADMIN IRLANDA SETTATO COME EDITOR
...
function remove_menus(){
  ...
  remove_menu_page( 'edit.php?post_type=heritage' );	//Heritage
  remove_menu_page( 'edit.php?post_type=inspiration' );	//Inspiration
  remove_menu_page( 'edit.php?post_type=coloring' );	//Coloring
  remove_menu_page( 'edit.php?post_type=straightening' );	//Straightening
  remove_menu_page( 'edit.php?post_type=page' );		//All page
  remove_menu_page( 'wpcf7' );							//CF7
  remove_menu_page( 'edit.php?post_type=acf-field-group' );	//Acf-field-group
  remove_menu_page( 'CF7DBPluginSubmissions' );	//CF DB
...
function remove_all_bar( $wp_admin_bar ) {
...
if( current_user_can('editor')) {  
    ...
    add_action( 'admin_bar_menu', 'remove_all_bar', 999 );
    add_action( 'wp_before_admin_bar_render', 'wpml_remove_admin_bar_menu', 200 );
 }

 
 
// FUNZIONE CH EMI PERMETTE DI AVERE L'ELENCO DELLE VOCI MENU DI ADMIN BAR
